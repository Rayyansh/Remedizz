...
#         return DoctorView().post(request)

#     @extend_schema(
#         description="Retrieve a single doctor or all doctors",
#         responses=SwaggerPage.response(response=DoctorResponseSerializer)
#     )
#     @api_view(['GET'])
#     @permission_classes([IsDoctor])
#     def get_doctor(request: Request, doctor_id=None) -> Response:
#         return DoctorView().get(request, doctor_id)
...
#     @api_view(['PUT'])
#     @permission_classes([IsAuthenticated, IsDoctor])
#     def update_doctor(request: Request, doctor_id) -> Response:
#         return DoctorView().put(request, doctor_id=doctor_id)
...
#     @api_view(['DELETE'])
#     @permission_classes([IsAuthenticated, IsDoctor])
#     def delete_doctor(request: Request, doctor_id) -> Response:
#         return DoctorView().delete(request, doctor_id=doctor_id)
